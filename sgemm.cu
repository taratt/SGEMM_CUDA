...
int main(int argc, char **argv) {
  ...
  std::vector<int> SIZE = {128, 256, 512,2048, 4096};
  long m, n, k, max_size;
  ...
  if (kernel_num >= 13) {
    ...
    // cudaCheck(cudaMalloc((void **)&dfA, sizeof(float) * max_size * max_size));
    // cudaCheck(cudaMalloc((void **)&dfB, sizeof(float) * max_size * max_size));
